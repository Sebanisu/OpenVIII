namespace OpenVIII.Fields.Scripts.Instructions
{
    internal sealed class DirP : JsmInstruction
    {
        ...
        public DirP(int parameter, IStack<IJsmExpression> stack)
            : this(
                arg2: stack.Pop(),
                arg1: stack.Pop(),
                arg0: stack.Pop())
        ...
        public override string ToString() => $"{nameof(DirP)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2})";
