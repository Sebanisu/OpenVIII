namespace OpenVIII.Fields.Scripts.Instructions
{
    internal sealed class FaceDir : JsmInstruction
    {
        ...
        public FaceDir(int parameter, IStack<IJsmExpression> stack)
            : this(
                arg3: stack.Pop(),
                arg2: stack.Pop(),
                arg1: stack.Pop(),
        ...
        public override string ToString() => $"{nameof(FaceDir)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3})";
