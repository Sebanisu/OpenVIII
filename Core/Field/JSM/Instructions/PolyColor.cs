namespace OpenVIII.Fields.Scripts.Instructions
{
    internal sealed class PolyColor : JsmInstruction
    {
        ...
        public PolyColor(int parameter, IStack<IJsmExpression> stack)
            : this(
                arg2: stack.Pop(),
                arg1: stack.Pop(),
                arg0: stack.Pop())
        ...
        public override string ToString() => $"{nameof(PolyColor)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2})";
