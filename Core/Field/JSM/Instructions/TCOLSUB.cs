namespace OpenVIII.Fields.Scripts.Instructions
{
    internal sealed class TColSub : JsmInstruction
    {
        ...
        public TColSub(int parameter, IStack<IJsmExpression> stack)
            : this(
                arg3: stack.Pop(),
                arg2: stack.Pop(),
                arg1: stack.Pop(),
        ...
        public override string ToString() => $"{nameof(TColSub)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3})";
